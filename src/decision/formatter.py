...
def format_final_output(candidate_insight: str, validation_summary: Dict[str, object], supporting_evidence: List[Dict[str, object]], statistical: Dict[str, object], biological: Dict[str, object], cohort: Dict[str, object]) -> Dict[str, object]:
    return {
